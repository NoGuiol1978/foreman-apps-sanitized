...
public class CgMiner
    ...
    protected void addStats(
        ...
        for (int i = 0; i < this.requests.size() && continueEval; i++) {
    ...
    private static String patchJson(
        ...
        // Patch miners returning '}{'
        goodJson = goodJson.replace("}{", "},{");

        // Patching miners ending in \x00
        goodJson = goodJson.replace("\\x00", "");
    ...
    public static class Builder
         ...
         * @param required Whether the request is required.
         *
        ...
        public Builder setConnectTimeout(
            ...
            this.connectTimeout = timeConfig.getTimeout();
            this.connectTimeoutUnits = timeConfig.getTimeoutUnits();
            return this;
        }
    ...
    private static class Request {
        ...
        /** Whether or not the provided request must see a response. */
         ...
         * @param patchingStrategy The patching strategy.
         * @param responseStrategy The response strategy.
         * @param required         Whether or not the request is required.
         */
        Request(
                final CgMinerRequest request,
                final ResponsePatchingStrategy patchingStrategy,

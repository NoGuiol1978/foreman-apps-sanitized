...
public class FirmwareAwareAction
    ...
    /** The seer action. */
    private final AsicAction.CompletableAction seerAction;

    /** The action for vnish firmware antminers. */
    private final AsicAction.CompletableAction vnishAction;
     ...
     * @param vnishAction              The vnish action.
     * @param seerAction               The seer action.
    ...
    public FirmwareAwareAction(
            ...
            final AsicAction.CompletableAction vnishAction,
            final AsicAction.CompletableAction seerAction,
            final ApplicationConfiguration applicationConfiguration) {
        this.realm = realm;
        this.antminerAction = antminerAction;
        this.braiinsAction = braiinsAction;
        this.vnishAction = vnishAction;

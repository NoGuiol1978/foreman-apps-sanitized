...
public enum WhatsminerType
    ...
    /** M29. */
    WHATSMINER_M29("WhatsMiner M29", "whatsminer-m29"),
    ...
    /** M30S+. */
    WHATSMINER_M30SPL("WhatsMiner M30SP", "whatsminer-m30s+"),

    /** M30S++. */
    WHATSMINER_M30SPP("WhatsMiner M30S++", "whatsminer-m30s++"),

    /** M30S++. */
    WHATSMINER_M30SPPL("WhatsMiner M30SPP", "whatsminer-m30s++"),

    /** M31+. */
    WHATSMINER_M31P("WhatsMiner M31+", "whatsminer-m31+"),

    /** M31+. */
    WHATSMINER_M31PL("WhatsMiner M31P", "whatsminer-m31+"),
    ...
    /** M31S+. */
    WHATSMINER_M31SPL("WhatsMiner M31SP", "whatsminer-m31s+"),

    /** M32. */
    WHATSMINER_M32("WhatsMiner M32", "whatsminer-m32"),

    /** M50. */
    WHATSMINER_M50("WhatsMiner M50", "whatsminer-m50"),

    /** M50S. */
    WHATSMINER_M50S("WhatsMiner M50S", "whatsminer-m50s");
    ...
    /** The version prefix. */
    private static final String WHATSMINER_PREFIX = "WhatsMiner ";
     ...
     *
     * @param original The version.
     *
     * @return The type.
     */
    public static Optional<WhatsminerType> fromVersion(final String original) {
        final String version =
                original != null && !original.contains(WHATSMINER_PREFIX)
                        ? WHATSMINER_PREFIX + original
                        : original;
        return VERSION_MAP
                .entrySet()
                .stream()

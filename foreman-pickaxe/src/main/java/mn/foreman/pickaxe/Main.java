...
public class Main {
    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            final File pickaxeFolder =
                    configFile
                            .getParentFile()
                            .getParentFile();
            final File firmwarePath =
                    new File(pickaxeFolder.getPath() + File.separator + "firmware");
            if (!firmwarePath.exists() && !firmwarePath.mkdir()) {
                LOG.warn("Failed to create firmware repository");
            }

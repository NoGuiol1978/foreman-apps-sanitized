...
public class MinerStats {
    ...
    private MinerStats(
            ...
            @JsonProperty("queryTimeMs") final long queryTimeMs) {
        Validate.notEmpty(
                apiIp,
    ...
    public static class Builder
        ...
        public Builder fromStats(final MinerStats stats) {
            ...
            setQueryTimeMs(stats.getQueryTimeMs());
            return this;
        }
         ...
         * Sets the query time.
         *
         * @param queryTimeMs The query time.
         *
         * @return This builder instance.
         */
        public Builder setQueryTimeMs(final long queryTimeMs) {
            this.queryTimeMs = queryTimeMs;
            return this;
        }
    }

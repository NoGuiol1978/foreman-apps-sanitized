...
public class FanInfo {
    ...
    public static class Builder
        ...
        public Builder addSpeed(
            ...
            // that aren't being used.  If there's a problem, the reported
            // speeds won't match the count, so an error will display
            final int candidate = Math.max(speed, 0);
            if (candidate != 0 || allowZero) {
                this.speeds.add(candidate);
            }
            return this;
        }
        ...
        public Builder addSpeed(final String speed) {
            if ((speed != null) && !speed.isEmpty()) {
                return addSpeed(Integer.parseInt(speed.trim()));
            }
            return this;
        }
        ...
        public Builder addSpeeds(
                ...
                final boolean allowZero) {
            speeds.forEach(speed -> addSpeed(speed, allowZero));
            return this;
        }

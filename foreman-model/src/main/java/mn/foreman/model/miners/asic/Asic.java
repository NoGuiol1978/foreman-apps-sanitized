...
public class Asic {
    ...
    public static class Builder
        ...
        /** The error codes. */
        private final List<String> errorCodes = new LinkedList<>();
        ...
        /**
         * Adds the provided error code.
         *
         * @param code The code.
         *
         * @return This builder instance.
         */
        public Asic.Builder addErrorCode(final String code) {
         ...
         *
         * @param temp      The new temperature reading.
         * @param allowZero Whether or not zeros are allowed.
         *
         * @return The builder instance.
         */
        public Builder addTemp(
        ...
        @Override
        public Asic build() {
            // Flatten the error codes
            if (!this.errorCodes.isEmpty()) {
                addAttribute(
                        "error_codes",
                        String.join("-", this.errorCodes));
            }
         ...
         * Sets the bminer.
         *
         * @param bmminer The bminer.
         *
         * @return This builder instance.
         */
        public Asic.Builder setBmminer(final String bmminer) {
            if (bmminer != null && !bmminer.isEmpty()) {
                addAttribute(
                        "bmminer",
                        bmminer);
            }
        ...
        /**
         * Sets the control board.
         *
         * @param controlBoard The control board.
         *
         * @return This builder instance.
         */
        public Asic.Builder setControlBoard(final String controlBoard) {
            addAttribute(
                    "control_board",
                    controlBoard);
            return this;
        ...
        /**
         * Sets whether or not liquid cooling.
         *
         * @param liquidCooling Whether or not liquid cooling.
         *
         * @return This builder instance.
         */
        public Asic.Builder setLiquidCooling(final String liquidCooling) {
            addAttribute(
                    "liquid_cooling",
                    liquidCooling);
            return this;
         ...
         * @return This builder instance.
         */
        public Asic.Builder setPower(final String power) {
            if (!"-1".equals(power)) {
                addAttribute(
                        "power",
                        power);
         ...
         * @return This builder instance.
         */
        public Asic.Builder setPower(final int power) {
            return setPower(Integer.toString(power));
        }

        /**
         * Sets the power limit.
         *
         * @param powerLimit The power limit.
         *
         * @return This builder instance.
         */
        public Asic.Builder setPowerLimit(final String powerLimit) {
            addAttribute(
                    "power_limit",
                    powerLimit);
            return this;
         ...
         * Sets the power rt.
         *
         * @param powerRt The power rt.
         *
         * @return This builder instance.
         */
        public Asic.Builder setPowerRt(final String powerRt) {
            addAttribute(
                    "power_rt",
                    powerRt);
            return this;
         ...
         * Sets the PSU serial.
         *
         * @param psuSerial The PSU serial.
         *
         * @return This builder instance.
         */
        public Asic.Builder setPsuSerial(final String psuSerial) {
            if (CharMatcher.ascii().matchesAllOf(psuSerial)) {
                addAttribute(
                        "psu_serial",
                        psuSerial);
            }
         ...
         * @return This builder instance.
         */
        public Asic.Builder setVoltage(final String voltage) {
            addAttribute(
                    "voltage",
                    voltage);
            return this;
